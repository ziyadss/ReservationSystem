        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StadiumName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Referee = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FirstLinesman = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SecondLinesman = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Matches", x => x.Id);
                    table.CheckConstraint("CK_Matches_HomeTeamName_AwayTeamName", "HomeTeamName <> AwayTeamName");
                    table.ForeignKey(
                        name: "FK_Matches_Stadiums_StadiumName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => new { x.MatchId, x.Row, x.Column });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_DateTime",
                table: "Matches",
                column: "DateTime");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_StadiumName",
                table: "Matches",
                column: "StadiumName");
